...
[![Start-Learning](https://img.shields.io/badge/Commencer-le-Parcours-whitesmoke?style=for-the-badge)](https://labex.io/fr/learn/lfcs)

Préparez-vous à l'examen Linux Foundation Certified System Administrator (LFCS) grâce à un parcours structuré et orienté pratique. Ce plan met l'accent sur l'administration Linux sur les distributions courantes, les tâches en mode performance et des scénarios réalistes. Des cours LFCS, des labs et des examens blancs seront ajoutés progressivement pour développer la maîtrise de la ligne de commande, des services, du stockage, du réseau, de la sécurité et du dépannage selon les objectifs LFCS.

**Cours**: 3 · **Labs**: 89

## Cours

### 1. [Préparation LFCS](https://labex.io/fr/courses/lfcs-prep)

Un cours de préparation au LFCS adapté aux débutants, comprenant 49 travaux pratiques guidés d'administration Linux, allant des flux de travail essentiels en ligne de commande à la gestion des utilisateurs, des services, du réseau et du stockage.
...
Un examen blanc pratique pour la certification LFCS composé de 20 défis d'administration Linux indépendants, couvrant les opérations et le déploiement, la mise en réseau, le stockage, les commandes essentielles, ainsi que la gestion des utilisateurs et des groupes.
